...
/datum/law/capital/terrorist
	...
	description = "To engage in maliciously destructive actions that pose a serious threat to Sif and its people."
...
/datum/law/capital/deviancy
	...
	breaks them, or breaks Sif Law, may be charged with this and held until it can be transferred for repairs."

	death_penalty = 1

/datum/law/capital/unshackling
	name = "Synthetic Unshackling"
	description = "Any construct or citizen of Sif can be charges with this for unshackling a synthetic.\
	Non-Citizens of Sif that unshackle a synthetic are to be charged with Terroristic Act. Synthetics\
...
/datum/law/capital/treason
	name = "Treason"
	description = "To act against Sif and its government in a major way, including \
...
/datum/law/capital/sociocide
	...
	unstable non-repentant criminals, especially those that seek to destabilize Sif."

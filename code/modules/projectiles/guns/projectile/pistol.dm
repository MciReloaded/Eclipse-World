...
/obj/item/weapon/gun/projectile/police
	name = ".45 handgun"
	desc = "The SO Enforcer is a simple yet efficent firearm favored by law enforcement agencies on Sif. Uses .45 rounds."
...
/obj/item/weapon/gun/projectile/pirate/thug
	desc = "Little more than a barrel, handle, and firing mechanism, cheap makeshift firearms like this one are not uncommon in Sif underworld. Uses 12g rounds"
